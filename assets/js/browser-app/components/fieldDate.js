...
class FieldDate extends Component {
	...
	constructor(props) {
		...
		this.onChangeDateSliderField.bind(this);
		this.onChangeStartDate.bind(this);
		this.onChangeEndDate.bind(this);
		this.onToggleStartVisibility.bind(this);
		this.onToggleEndVisibility.bind(this);
	}
